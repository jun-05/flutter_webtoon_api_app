...
import 'package:webtoon_api_app/models/webtoon_detail_model.dart';
import 'package:webtoon_api_app/models/webtoon_episode_model.dart';
import 'package:webtoon_api_app/services/api_service.dart';
import 'package:webtoon_api_app/widgets/episode_widget.dart';
            ...
            child: Column(
              children: [
                ...
                FutureBuilder<WebtoonDetailModel>(
                  future: webtoon,
                  builder: (context, webtoon) {
                    if (webtoon.hasData) {
                      return FutureBuilder<List<WebtoonEpisodeModel>>(
                        future: episode,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          '${webtoon.data!.genre} / ${webtoon.data!.age}',
